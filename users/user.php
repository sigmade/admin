...
<body>
  ...
  <main class="container mt-5">
    <div class="row">
      ...
      <h5>Пользователь</h5>
      <form method="post" action="../models/updt_us.php">
                  <table class='table print'>
                  <tr><td>ID</td><td><input type='text' name='id' value='<?=$row['id']?>'</td></tr>
                  <tr><td>Логин</td><td><input type='text' name='login' value='<?=$row['login']?>'></td></tr>
                  <tr><td>Пароль</td><td><input type='text' name='pass' value='<?=$row['pass']?>'></td></tr>
                  ...
                  <tr><td>Телефон</td><td><input type='text' name='phone' value='<?=$row['phone']?>'></td></tr>
                  <tr><td>Группа</td><td><input type='text' name='group' value='<?=$row['group']?>'></td></tr>
                  </table><br>
