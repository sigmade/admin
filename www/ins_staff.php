  ...
  <main class="container mt-5">
    <div class="row">
      <div class="col-md-8 mb-3">
        ...
        <ol class="breadcrumb">
       <li class="breadcrumb-item"><a href="/staff.php">Список</a></li>
       <li class="breadcrumb-item active" aria-current="page">Добавить</a></li>
       <li class="breadcrumb-item"><a href="#">Изменить</a></li>
       </ol>
       </nav>
       <form action="./libs/ins_st.php" method="post" class="form-group">
       <table>
